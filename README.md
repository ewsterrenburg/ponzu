...
A first go at getting everything working well with modules, everything major seems to be working.I have not done anything with addons so that needs to be checked.
Possible to use `export GO111MODULE=on` and `export GOFLAGS=-mod=vendor` for another appreoach but this works for now anyway.
...
# Ponzu
[![Current Release](https://img.shields.io/github/release/ponzu-cms/ponzu.svg)](https://github.com/padraicbc/ponzu/releases/latest)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/padraicbc/ponzu)
...
```
$ go get -u github.com/padraicbc/ponzu/...
```
...
clone the 'github.com/padraicbc/ponzu' package from over the network.
...
package by running `$ go get -u github.com/padraicbc/ponzu/...` 
...
$ git clone https://github.com/padraicbc/ponzu path/to/local/ponzu # (or your fork)
$ git checkout ponzu-dev

# install ponzu with go get or from your own local path
$ go get github.com/padraicbc/ponzu/...
# or
...
# ... go to https://github.com/padraicbc/ponzu and create a PR
```
